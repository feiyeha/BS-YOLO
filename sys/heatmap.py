...
class yolo_heatmap:
    ...
    def process(self, img_path, save_path):
        ...
        try:
            ...
            return
        img, _, (top, bottom, left, right) = letterbox(img, new_shape=(self.img_size, self.img_size), auto=False,
                                                       stride=32)  # 如果需要完全固定成宽高一样就把auto设置为False
...
def get_params():
    params = {
        'weight': r"G:\sc\ultralytics-yolo11-main\BS-YOLO.pt",  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r"G:\sc\ultralytics-yolo11-main\2\images", 'result')
